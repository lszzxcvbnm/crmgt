...
request.getServerPort() + request.getContextPath() + "/";
   ...
   /*String fullname=request.getParameter("fullname");
	...
	String appllation=request.getParameter("appellation");
...
<script type="text/javascript">
    ...
    //        为搜索操作模态窗口的搜索框绑定事件，搜索市场活动
		$("#aname").keydown(function(event){
            if(event.keyCode==13){
              $.ajax({
              	url:"workbench/clue/getActivityListByName.dao",
				  data:{
		...
		$("#convertBtn").click(function(){
          ...
          if($("#isCreateTransaction").prop("checked")){
          	   ...
          	   //alert("需要创建交易");
			  //除了clueid外还需要表单参数
			 // window.location.href="workbench/clue/convert.dao?clueId=${param.id}";
             //提交表单来发出传动请求，参数不用挂载，可以用post请求
            $("#tranForm").submit();
		  }else{
			  //alert("不需要创建交易");
			  //传clueID 就可以了
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form  id="tranForm" action="workbench/clue/convert.dao" method="post ">
